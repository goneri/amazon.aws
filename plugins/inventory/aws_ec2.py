...
DOCUMENTATION = '''
    ...
    options:
        ...
        includes_entries_matching:
          description:
              - A list of filters. The instances matching at least one of the filters are included in the result.
              - Available filters are listed here U(http://docs.aws.amazon.com/cli/latest/reference/ec2/describe-instances.html#options).
              - Every entry of this list trigger a search query. This is the reason why from a performance point of view, it's better to
